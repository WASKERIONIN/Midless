...
FLORA = [
    ...
    (64, 64, "Void Glowcap",  "Пустотный светлогриб"),
    (65, 65, "Ember Cap",     "Угольный гриб"),
    (66, 66, "Frost Cap",     "Морозный гриб"),
...
BIOME_NOTE = [
    ...
    ("Угольные острова", "угольный камень и дёрн, тлеголовка, угольная гроздь, угольная линза, двойной тюльпан, фонарная ягода, угольные грибы, фонарные деревья, угольная трава"),
    ("Морозные острова", "морозный дёрн, морозная звезда, ледяная луковица, кольцецвет, морозник, морозные грибы, пуховки, пустотные деревья, морозная трава"),
]
SECTIONS = [
