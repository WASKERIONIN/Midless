...
BIOME_NOTE = [
    ...
    ("Угольные острова", "угольный камень и дёрн, тлеголовка, угольные бутоны, угольный фонарик, двойной тюльпан, фонарная ягода, фонарные деревья, угольная трава; под дождём - угольная труба"),
    ("Морозные острова", "морозный дёрн, морозный салют, ледяная снегокапля, кольцецвет, морозник, пуховки, пустотные деревья, морозная трава; под дождём - морозный дождевик"),
]
SECTIONS = [
