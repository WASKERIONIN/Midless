...
FLORA = [
    ...
    (73, 73, "Void Glowcaps (rain)", "Пустотные светлогрибы (дождь)"),
    (74, 74, "Cinder Trumpet (rain)", "Угольная труба (дождь)"),
    (75, 75, "Frost Puffball (rain)", "Морозный дождевик (дождь)"),
    (67, 67, "Smolderhead",   "Тлеголовка"),
    (68, 68, "Cinder Cluster","Угольная гроздь"),
    (69, 69, "Ember Lens",    "Угольная линза"),
    (70, 70, "Frost Star",    "Морозная звезда"),
    (71, 71, "Glacier Bulb",  "Ледяная луковица"),
...
BIOME_NOTE = [
    ("Классический архипелаг", "камень и кристальный дёрн, все классические цветы, пустотные деревья; грибы растут только под дождём"),
    ("Угольные острова", "угольный камень и дёрн, тлеголовка, угольная гроздь, угольная линза, двойной тюльпан, фонарная ягода, фонарные деревья, угольная трава; под дождём - угольная труба"),
    ("Морозные острова", "морозный дёрн, морозная звезда, ледяная луковица, кольцецвет, морозник, пуховки, пустотные деревья, морозная трава; под дождём - морозный дождевик"),
]
SECTIONS = [
