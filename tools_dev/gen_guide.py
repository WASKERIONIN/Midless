...
BIOME_NOTE = [
    ("Классический архипелаг", "кристальный дёрн всегда в пустотной траве; все классические цветы, пустотные деревья; грибы растут только под дождём"),
    ("Угольные острова", "угольный дёрн всегда в угольной траве; тлеголовка, угольные бутоны, угольный фонарик, двойной тюльпан, фонарная ягода, фонарные деревья; под дождём - угольная труба"),
    ("Морозные острова", "морозный дёрн всегда в морозной траве; морозный салют, ледяная снегокапля, кольцецвет, морозник, пуховки, пустотные деревья; под дождём - морозный дождевик"),
]
SECTIONS = [
