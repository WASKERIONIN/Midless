...
BIOME_NOTE = [
    ("Классический архипелаг", "камень и кристальный дёрн, все классические цветы, пустотные деревья"),
    ("Угольные острова", "угольный камень и дёрн, угольник, двойной тюльпан, фонарная ягода, фонарные деревья, угольная трава"),
    ("Морозные острова", "морозный дёрн, морозник, стеклобел, пуховки, пустотные деревья, морозная трава"),
]
SECTIONS = [
